...
export const projects = [
  ...
  },
  {
    ...
    businessImpact: "Auditing field changes went from slow and confusing to fast and intuitive.",
    ...
    impact: [
      { metric: "Modern", label: "LWC architecture" },
      { metric: "Faster", label: "Change auditing" },
    ],
