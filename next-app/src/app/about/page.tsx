...
import { siteConfig, aboutData, processSteps, experience } from "@/data/mock";
    ...
    <main className="pt-20">
      ...
      <section className="py-32 bg-[#F1F1EF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <MotionSection>
                <p className="text-[13px] uppercase tracking-[0.2em] text-[#CB9135] mb-4">— About</p>
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#2F2E2E] leading-tight mb-6 tracking-tight">
                  {aboutData.intro}
                </h1>
              </MotionSection>
              <MotionSection delay={0.1}>
                <p className="text-lg text-[#4B5563] leading-relaxed mb-6">{aboutData.approach}</p>
              ...
              <div className="flex justify-center lg:justify-end">
                <div className="relative group">
                  <motion.div
                    ...
                    transition={{ delay: 0.6, duration: 0.6, ease: EASE_PREMIUM }}
                  />
                  <div className="absolute -inset-6 bg-gradient-to-br from-[#CB9135]/10 via-transparent to-[#2F2E2E]/5 rounded-3xl blur-xl" />
                  <motion.div
                  ...
                  <motion.div
                    ...
                    initial={{ scaleY: 0 }}
                    animate={{ scaleY: 1 }}
                    transition={{ delay: 0.8, duration: 0.5, ease: EASE_PREMIUM }}
                  />
                </div>
              </div>
            </MotionSection>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <MotionSection>
            <p className="text-[13px] uppercase tracking-[0.2em] text-[#CB9135] mb-4">— Story</p>
            <h2 className="text-3xl md:text-4xl font-bold text-[#2F2E2E] mb-10 tracking-tight">My path</h2>
          </MotionSection>
          {aboutData.story.map((paragraph, i) => (
            <MotionSection key={i} delay={i * 0.1}>
              <p className="text-[#4B5563] leading-relaxed mb-6 text-[16px]">{paragraph}</p>
            </MotionSection>
          ))}
        </div>
      </section>
      ...
      <section className="py-32 bg-[#F1F1EF]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <MotionSection>
            <div className="mb-14">
              <p className="text-[13px] uppercase tracking-[0.2em] text-[#CB9135] mb-4">— Approach</p>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2F2E2E] tracking-tight">How I work</h2>
            </div>
          </MotionSection>
      ...
      <section className="py-32 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <MotionSection>
            <div className="mb-14">
              <p className="text-[13px] uppercase tracking-[0.2em] text-[#CB9135] mb-4">— Career</p>
              <h2 className="text-3xl md:text-4xl font-bold text-[#2F2E2E] tracking-tight">Experience</h2>
            </div>
          </MotionSection>
              ...
              <MotionSection key={i} delay={i * 0.1}>
                <div className="relative pl-10 pb-16 last:pb-0">
                  ...
                  <div className="flex flex-col gap-1">
                    <span className="text-sm text-[#4B5563] tabular-nums">{role.period}</span>
                    <h3 className="text-lg font-semibold text-[#2F2E2E]">{role.role}</h3>
                    <p className="text-[#CB9135] text-sm font-medium">{role.company}</p>
                    <p className="text-sm text-[#4B5563] leading-relaxed mt-2">{role.description}</p>
