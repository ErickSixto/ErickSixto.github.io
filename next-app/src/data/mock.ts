...
export const siteConfig = {
  ...
  subheadline:
    "I'm an engineer who ended up in Salesforce. 7 years of it — most of that spent fixing orgs that got harder to use every time someone tried to improve them.",
