...
import { PlatformLinksCompact } from "@/components/platform-links";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          <div className="md:col-span-1">
            <Link href="/" className="flex items-center gap-3 mb-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-gray-500 uppercase tracking-[0.15em] leading-none mt-1">
                  {siteConfig.descriptor}
                </span>
              </div>
            </Link>
            <p className="text-sm text-gray-500 leading-relaxed max-w-xs mt-4">
              Senior Salesforce Specialist. Available for consulting, freelance, and senior contract
              work.
            </p>
          </div>

          <div>
            <h4 className="text-xs font-medium uppercase tracking-[0.15em] text-gray-600 mb-5">
              Navigation
            </h4>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                className="text-sm text-gray-400 hover:text-white transition-colors duration-200 flex items-center gap-2.5"
              >
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                href={meetingLinks.consultation.url}
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm text-gray-400 hover:text-white transition-colors duration-200 flex items-center gap-2.5"
              >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-3">
          <p className="text-xs text-gray-600">
            &copy; {new Date().getFullYear()} Erick Sixto. All rights reserved.
          </p>
